...
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-hostel-view', 'hostel.view', 'View hostel blocks, rooms, and allocations');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-hostel-manage', 'hostel.manage', 'Manage hostel blocks, rooms, allocations, and billing');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-medical-view', 'medical.view', 'View student medical/health records');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-medical-manage', 'medical.manage', 'Record student health visits, immunizations, and incidents');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-canteen-view', 'canteen.view', 'View canteen menu, meal plans, and subscriptions');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-canteen-manage', 'canteen.manage', 'Manage canteen menu, meal plans, subscriptions, and billing');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-study-materials-view', 'study_materials.view', 'View study materials for enrolled sections/subjects');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-study-materials-manage', 'study_materials.manage', 'Upload and manage study materials');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-faculty-research-view', 'faculty_research.view', 'View faculty research/publication records');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-faculty-research-manage', 'faculty_research.manage', 'Record and manage faculty research/publications');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-gl-view', 'gl.view', 'View chart of accounts, journal entries, and ledger reports');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-gl-manage', 'gl.manage', 'Manage chart of accounts and post journal entries');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-compliance-view', 'compliance.view', 'View statutory/regulatory compliance reports');
INSERT OR REPLACE INTO permissions (id, code, description) VALUES ('perm-compliance-manage', 'compliance.manage', 'Generate and export compliance reports');

INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-super-admin', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'calendar.view', 'calendar.manage', 'timetable.view', 'timetable.manage', 'teacher_attendance.view', 'teacher_attendance.manage', 'homework.view', 'homework.manage', 'library.access', 'library.manage', 'transport.view', 'transport.manage', 'certificates.view', 'certificates.manage', 'admissions.view', 'admissions.manage', 'approvals.view', 'approvals.manage', 'setup.manage', 'data_tools.manage', 'visitors.manage', 'assets.manage', 'alumni.manage', 'hostel.view', 'hostel.manage', 'medical.view', 'medical.manage', 'canteen.view', 'canteen.manage', 'study_materials.view', 'study_materials.manage', 'faculty_research.view', 'faculty_research.manage', 'gl.view', 'gl.manage', 'compliance.view', 'compliance.manage');
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-principal', permission_id FROM role_permissions WHERE role_id = 'role-super-admin';
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-hod', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'calendar.view', 'calendar.manage', 'timetable.view', 'timetable.manage', 'teacher_attendance.view', 'teacher_attendance.manage', 'homework.view', 'homework.manage', 'library.access', 'transport.view', 'certificates.view', 'certificates.manage', 'admissions.view', 'admissions.manage', 'approvals.view', 'approvals.manage', 'setup.manage', 'visitors.manage', 'alumni.manage', 'hostel.view', 'medical.view', 'canteen.view', 'study_materials.view', 'study_materials.manage', 'faculty_research.view', 'compliance.view');
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-teacher', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'calendar.view', 'timetable.view', 'homework.view', 'homework.manage', 'library.access', 'certificates.view', 'certificates.manage', 'study_materials.view', 'study_materials.manage', 'faculty_research.view', 'faculty_research.manage');
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-accountant', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'transport.view', 'transport.manage', 'library.access', 'hostel.view', 'hostel.manage', 'canteen.view', 'canteen.manage', 'gl.view', 'gl.manage');
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-student', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'calendar.view', 'timetable.view', 'homework.view', 'library.access', 'transport.view', 'hostel.view', 'medical.view', 'canteen.view', 'study_materials.view');
INSERT OR REPLACE INTO role_permissions (role_id, permission_id) SELECT 'role-parent', id FROM permissions WHERE code IN ('dashboard.access', 'profile.access', 'notifications.view', 'calendar.view', 'timetable.view', 'homework.view', 'library.access', 'transport.view', 'hostel.view', 'medical.view', 'canteen.view', 'study_materials.view');
